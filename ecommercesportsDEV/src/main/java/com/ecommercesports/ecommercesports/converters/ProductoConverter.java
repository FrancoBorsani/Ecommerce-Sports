...
public class ProductoConverter {
    ...
    public ProductoModel entityToModel(Producto producto) {
        return new ProductoModel(producto.getIdProducto(),producto.getPrecio(), producto.getPrecioEnOferta(), producto.getColor(),
                ...
                producto.getTotalPuntaje(), producto.getCantidadValoraciones(), producto.getPeso(), producto.getTags(), producto.isVisible(), producto.getImagen(), producto.getListaValoraciones(), producto.getCategoria(), producto.getMarca());}
    ...
    public Producto modelToEntity(ProductoModel productoModel) {
        return new Producto(productoModel.getIdProducto(),productoModel.getPrecio(), productoModel.getPrecioEnOferta(), productoModel.getColor(),
                ...
                productoModel.getPeso(), productoModel.getTags(),productoModel.isVisible(), productoModel.getImagen(), productoModel.getListaValoraciones(),productoModel.getCategoria(), productoModel.getMarca());
    }
}